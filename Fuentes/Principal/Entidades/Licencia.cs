        ...
        public List<Licencia> ObtenerListado()
        {
            ...
            try
            {
                ...
                while ((lectorDatos.Read()))
                {
                    ...
                    licencia.esPrueba = Convert.ToBoolean(lectorDatos["EsPrueba"].ToString());
                    licencia.fechaRegistro = Convert.ToDateTime(lectorDatos["FechaRegistro"].ToString());
                    licencia.fechaVencimiento = Convert.ToDateTime(lectorDatos["FechaVencimiento"].ToString());
                    lista.Add(licencia);
                }
