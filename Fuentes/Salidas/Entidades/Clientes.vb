    ...
    Public Function ObtenerListado() As List(Of Clientes)
        ...
        Try
            ...
            While lectorDatos.Read()
                ...
                clientes.id = Convert.ToInt32(lectorDatos("Id").ToString())
                clientes.nombre = lectorDatos("Nombre").ToString()
                clientes.rfc = lectorDatos("Rfc").ToString()
                clientes.domicilio = lectorDatos("Domicilio").ToString()
                clientes.municipio = lectorDatos("Municipio").ToString()
                clientes.estado = lectorDatos("Estado").ToString()
                clientes.telefono = lectorDatos("Telefono").ToString()
                clientes.correo = lectorDatos("Correo").ToString()
                lista.Add(clientes)
            End While
            BaseDatos.conexionCatalogo.Close()
            Return lista
