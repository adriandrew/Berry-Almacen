...
Public Class Entradas
    ...
    Public Function ObtenerListado() As List(Of Entradas)
        ...
        Try
            ...
            BaseDatos.conexionAlmacen.Open()
            Dim lectorDatos As SqlDataReader = comando.ExecuteReader()
            Dim entradas As Entradas
            While lectorDatos.Read()
                entradas = New Entradas()
                entradas.idAlmacen = Convert.ToInt32(lectorDatos("IdAlmacen").ToString())
                entradas.idFamilia = Convert.ToInt32(lectorDatos("IdFamilia").ToString())
                entradas.idSubFamilia = Convert.ToInt32(lectorDatos("IdSubFamilia").ToString())
                entradas.idArticulo = Convert.ToInt32(lectorDatos("IdArticulo").ToString())
                entradas.id = Convert.ToInt32(lectorDatos("Id").ToString())
                entradas.idExterno = lectorDatos("IdExterno").ToString()
                entradas.idTipoEntrada = lectorDatos("IdTipoEntrada").ToString()
                entradas.idProveedor = Convert.ToInt32(lectorDatos("IdProveedor").ToString())
                entradas.idMoneda = Convert.ToInt32(lectorDatos("IdMoneda").ToString())
                entradas.tipoCambio = Convert.ToDouble(lectorDatos("TipoCambio").ToString())
                entradas.fecha = Convert.ToDateTime(lectorDatos("Fecha").ToString())
                entradas.cantidad = Convert.ToInt32(lectorDatos("Cantidad").ToString())
                entradas.precioUnitario = Convert.ToDouble(lectorDatos("PrecioUnitario").ToString())
                entradas.total = Convert.ToDouble(lectorDatos("Total").ToString())
                entradas.totalPesos = Convert.ToDouble(lectorDatos("TotalPesos").ToString())
                entradas.orden = Convert.ToInt32(lectorDatos("Orden").ToString())
                entradas.observaciones = lectorDatos("Observaciones").ToString()
                entradas.factura = lectorDatos("Factura").ToString()
                entradas.chofer = lectorDatos("Chofer").ToString()
                entradas.camion = lectorDatos("Camion").ToString()
                entradas.noEconomico = lectorDatos("NoEconomico").ToString()
                lista.Add(entradas)
            End While
            BaseDatos.conexionAlmacen.Close()
            Return lista
